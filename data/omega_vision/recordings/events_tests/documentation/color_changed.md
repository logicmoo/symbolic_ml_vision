...
Only the object's color changes.

**Execution status: not run.**

## Local memory required for this test

Prior appearance attached to the observation/identity, separate from the colorless Shape key

## Measured new evidence and decision / episode timing

At `1`, geometry and placement stay fixed while blue becomes red

## Required caution and fixture insufficiency

Do not change object identity simply because color changed, or make Shape identity color-dependent.
...
|---|---|---|
| `recordings/events_tests/color_changed` | event_baseline | 2 |
