...
Push then move the actor away; crate stops in a non-inertial mechanism
...
Distinguish push from attachment, carry and autonomous co-motion
...
Temporary contact must not permanently merge identities or assert an attachment episode.

- **train_a**: Training example. Push the crate twice with a pause, then retreat and leave the lane; the crate remains stationary after release. Trace: plate occupancy=not applicable; crate movement=present; door changes=not applicable; wall removal=not applicable.
- **train_b**: Training example. Push the crate twice with a pause, then retreat and leave the lane; the crate remains stationary after release. Trace: plate occupancy=not applicable; crate movement=present; door changes=not applicable; wall removal=not applicable.
- **control_a**: Training control. Move without contacting the crate; no push or subsequent crate displacement occurs. Trace: plate occupancy=not applicable; crate movement=absent; door changes=not applicable; wall removal=not applicable.
- **validation_a**: Held-out validation example. Push the crate twice with a pause, then retreat and leave the lane; the crate remains stationary after release. Trace: plate occupancy=not applicable; crate movement=present; door changes=not applicable; wall removal=not applicable.
- **test_a**: Frozen final example. Push the crate twice with a pause, then retreat and leave the lane; the crate remains stationary after release. Trace: plate occupancy=not applicable; crate movement=present; door changes=not applicable; wall removal=not applicable.
- **test_control_a**: Frozen final control. Move without contacting the crate; no push or subsequent crate displacement occurs. Trace: plate occupancy=not applicable; crate movement=absent; door changes=not applicable; wall removal=not applicable.
...
The actor pushes, pauses, pushes again, then retreats and leaves the lane. The crate stops when not pushed. Temporary contact does not fuse identities or prove attachment, carry or an autonomous co-motion episode.
...
|---|---|---|
| `recordings/events_tests/push_release_train_a` | training | 11 |
| `recordings/events_tests/push_release_train_b` | training | 13 |
| `recordings/events_tests/push_release_control_a` | training_control | 14 |
| `recordings/events_tests/push_release_validation_a` | validation | 11 |
| `recordings/events_tests/push_release_test_a` | test | 13 |
| `recordings/events_tests/push_release_test_control_a` | test_control | 14 |
