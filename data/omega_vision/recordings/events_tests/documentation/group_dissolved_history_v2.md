# group dissolved history v2

An existing assembly separates into independent pieces. Includes independent observations before the membership change.
...
- A prior group must already be established.
...
- Frame 4: `{'predicate': 'group_dissolved', 'args': ['group']}` (decision uses only frames 0 through 4).
...
`recordings/events_tests/group_dissolved_history_v2` contains 6 numbered frames from 0.
