...
Two approaching objects contact, then recoil.

**Execution status: not run.**

## Local memory required for this test

Both approach vectors, shared boundary at `1`, both recoil vectors at `2`

## Measured new evidence and decision / episode timing

Confirm no earlier than `2`, citing contact at `1` and motion response at `2`

## Required caution and fixture insufficiency

The current oracle targets `1`; that is contact time, not causal confirmation time. Preserve the fixture and plan an explicit timing correction/version.
...
|---|---|---|
| `recordings/events_tests/collision` | event_baseline | 3 |
