# group formed confirmed v2

Two independent pieces form a coherent moving assembly. Classification waits for the supporting later observation.
...
- Group identity/membership is annotated intent, not implied by proximity alone.
...
- Frame 2: `{'predicate': 'group_formed', 'args': ['group']}` (decision uses only frames 0 through 2).
...
`recordings/events_tests/group_formed_confirmed_v2` contains 3 numbered frames from 0.
