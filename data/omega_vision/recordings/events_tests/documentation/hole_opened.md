...
An interior empty region opens in a solid object.

**Execution status: not run.**

## Local memory required for this test

Previous enclosing contour, interior components and holes

## Measured new evidence and decision / episode timing

At `1`, one interior hole appears while the outer boundary stays fixed

## Required caution and fixture insufficiency

Exterior background, an overlapping occluder and a break in the outer boundary are different evidence.
...
|---|---|---|
| `recordings/events_tests/hole_opened` | event_baseline | 2 |
