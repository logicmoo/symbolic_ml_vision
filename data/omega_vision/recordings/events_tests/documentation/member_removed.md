...
One member leaves while a two-member assembly survives.

**Execution status: not run.**

## Local memory required for this test

Existing three-member membership and surviving subgroup evidence

## Measured new evidence and decision / episode timing

At `1`, the third member leaves while the other two remain; `2` supports the retained group

## Required caution and fixture insufficiency

Removal is not dissolution or deletion of the departing object's identity.
...
|---|---|---|
| `recordings/events_tests/member_removed` | event_baseline | 3 |
