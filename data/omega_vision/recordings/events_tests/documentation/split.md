...
One connected body separates into two equal-area children.

**Execution status: not run.**

## Local memory required for this test

Source identity/mask at `0`, conservation/locality evidence and a one-to-many correspondence hypothesis

## Measured new evidence and decision / episode timing

At `1`, propose two children with total area 72; separation at `2` tests the lineage hypothesis

## Required caution and fixture insufficiency

Equal area is supporting evidence, not proof. Rule out occlusion and unrelated appearances; never force one-to-one identity matching.
...
|---|---|---|
| `recordings/events_tests/split` | event_baseline | 3 |
