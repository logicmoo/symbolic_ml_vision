...
Rightward speed increases from two to four pixels per second.

**Execution status: not run.**

## Local memory required for this test

Positions/times at `0`, `1`, `2`, and the previous speed

## Measured new evidence and decision / episode timing

At `2`, speed increases from 2 to 4 pixels per second

## Required caution and fixture insufficiency

Reject a change caused only by unequal sample intervals, camera motion or identity mismatch.
...
|---|---|---|
| `recordings/events_tests/accelerated` | event_baseline | 3 |
