...
Two separate bodies fuse into one connected result.

**Execution status: not run.**

## Local memory required for this test

Two distinct source identities/masks and a many-to-one hypothesis

## Measured new evidence and decision / episode timing

At `1`, propose a connected 72-pixel result; persistence at `2` supports it

## Required caution and fixture insufficiency

Touching or one object hiding another must not automatically become a merge. Keep source identities in immutable history.
...
|---|---|---|
| `recordings/events_tests/merged` | event_baseline | 3 |
