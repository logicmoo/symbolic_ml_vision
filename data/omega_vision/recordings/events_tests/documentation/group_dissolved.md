...
An existing assembly separates into independent pieces.

**Execution status: not run.**

## Local memory required for this test

A genuinely established baseline group and its membership revision

## Measured new evidence and decision / episode timing

At `1`, formerly grouped members separate; `2` confirms independent continuation

## Required caution and fixture insufficiency

The label in frame `0`'s oracle is not an established group. Add independently supported prehistory or keep the claim unavailable.
...
|---|---|---|
| `recordings/events_tests/group_dissolved` | event_baseline | 3 |
