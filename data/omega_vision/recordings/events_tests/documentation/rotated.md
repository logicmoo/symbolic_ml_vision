...
An asymmetric L rotates 90 degrees clockwise in place.

**Execution status: not run.**

## Local memory required for this test

Previous asymmetric L mask, orientation and matched identity

## Measured new evidence and decision / episode timing

At `1`, fit the 90-degree rigid transform and verify equal area/color

## Required caution and fixture insufficiency

Shape symmetry can make angle unknowable; do not manufacture a rotation for a symmetric square.
...
|---|---|---|
| `recordings/events_tests/rotated` | event_baseline | 2 |
