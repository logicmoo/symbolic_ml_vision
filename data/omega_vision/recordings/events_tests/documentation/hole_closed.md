...
An object's enclosed hole is filled.

**Execution status: not run.**

## Local memory required for this test

Prior interior-hole record and the same enclosing identity

## Measured new evidence and decision / episode timing

At `1`, the single hole is filled with the object's appearance

## Required caution and fixture insufficiency

A lost contour, occluded hole or changed crop is not proof of filling.
...
|---|---|---|
| `recordings/events_tests/hole_closed` | event_baseline | 2 |
