...
Ambiguity control: identical-looking objects meet and identity is unresolved.

**Execution status: not run.**

## Local memory required for this test

Both indistinguishable track histories and alternative correspondences through coincidence

## Measured new evidence and decision / episode timing

Preserve bounce, pass-through and identity-swap alternatives through frames `1` and `2`

## Required caution and fixture insufficiency

Do not choose an identity because the oracle names it. Ambiguous comparisons remain `unknown`; do not learn a positive collision/merge from them.
...
|---|---|---|
| `recordings/events_tests/unknown` | event_baseline | 3 |
