...
A moving object contacts a wall then reverses direction.

**Execution status: not run.**

## Local memory required for this test

Actor's approach vector, wall geometry/contact at `1`, current outgoing vector

## Measured new evidence and decision / episode timing

At `2`, detect reversal after contact; `3` supports persistence

## Required caution and fixture insufficiency

Memory must preserve the contact and pre-impact direction. A stop, voluntary turn or contact alone is not a bounce.
...
|---|---|---|
| `recordings/events_tests/bounce` | event_baseline | 4 |
