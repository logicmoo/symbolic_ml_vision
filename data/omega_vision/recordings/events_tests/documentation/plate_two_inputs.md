...
Occupy A alone, B alone, both, neither, and release either
...
Distinguish conjunctive/alternative requirements from single-plate coincidence
...
Independent interventions cover the truth table; do not claim arbitrary Boolean-rule synthesis exists today.

- **train_a**: Training example. Push a crate onto A and independently occupy B with the actor; cover A alone, both, B alone and neither, including releases. Trace: plate occupancy=present; crate movement=present; door changes=present; wall removal=not applicable.
- **train_b**: Training example. Push a crate onto A and independently occupy B with the actor; cover A alone, both, B alone and neither, including releases. Trace: plate occupancy=present; crate movement=present; door changes=present; wall removal=not applicable.
- **control_a**: Training control. Push a crate onto A only; B remains empty and the door remains closed throughout the completed horizon. Trace: plate occupancy=present; crate movement=present; door changes=absent; wall removal=not applicable.
- **validation_a**: Held-out validation example. Push a crate onto A and independently occupy B with the actor; cover A alone, both, B alone and neither, including releases. Trace: plate occupancy=present; crate movement=present; door changes=present; wall removal=not applicable.
- **test_a**: Frozen final example. Push a crate onto A and independently occupy B with the actor; cover A alone, both, B alone and neither, including releases. Trace: plate occupancy=present; crate movement=present; door changes=present; wall removal=not applicable.
- **test_control_a**: Frozen final control. Push a crate onto A only; B remains empty and the door remains closed throughout the completed horizon. Trace: plate occupancy=present; crate movement=present; door changes=absent; wall removal=not applicable.
...
The fixture requires A AND B. A crate supplies A while the actor independently supplies B. Main trials observe neither, A only, both, release B, neither, B only, then neither. The A-only control completes its horizon without opening.
...
|---|---|---|---|
| train_a | 3, 12, 16, 29, 33, 37 | 12, 16 | 3, 25 |
| train_b | 4, 14, 19, 34, 38, 43 | 14, 19 | 4, 29 |
| control_a | 5 | none | 5 |
| validation_a | 3, 12, 16, 29, 33, 37 | 12, 16 | 3, 25 |
| test_a | 4, 14, 19, 34, 38, 43 | 14, 19 | 4, 29 |
| test_control_a | 5 | none | 5 |
...
|---|---|---|
| `recordings/events_tests/plate_two_inputs_train_a` | training | 41 |
| `recordings/events_tests/plate_two_inputs_train_b` | training | 48 |
| `recordings/events_tests/plate_two_inputs_control_a` | training_control | 22 |
| `recordings/events_tests/plate_two_inputs_validation_a` | validation | 41 |
| `recordings/events_tests/plate_two_inputs_test_a` | test | 48 |
| `recordings/events_tests/plate_two_inputs_test_control_a` | test_control | 22 |
