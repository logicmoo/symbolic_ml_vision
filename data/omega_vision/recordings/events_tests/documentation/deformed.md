...
A square stretches horizontally and compresses vertically.

**Execution status: not run.**

## Local memory required for this test

Previous contour, area and aspect ratio

## Measured new evidence and decision / episode timing

At `1`, compare 6x6 with 12x3: area remains 36 but horizontal/vertical scales differ

## Required caution and fixture insufficiency

This is a nonuniform shape change, not uniform scale. Retain measured transform alternatives.
...
|---|---|---|
| `recordings/events_tests/deformed` | event_baseline | 2 |
