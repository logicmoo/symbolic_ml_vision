...
A square grows uniformly about its center.

**Execution status: not run.**

## Local memory required for this test

Previous contour/mask, center, dimensions and identity

## Measured new evidence and decision / episode timing

At `1`, fit uniform scaling from 6x6 to 10x10 about the same center

## Required caution and fixture insufficiency

A changed bounding box alone is not enough; partial occlusion and nonuniform stretch must be excluded.
...
|---|---|---|
| `recordings/events_tests/scaled` | event_baseline | 2 |
