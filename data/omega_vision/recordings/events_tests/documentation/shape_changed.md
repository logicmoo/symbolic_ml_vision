...
An equal-area L becomes a cross, not a rigid rotation.

**Execution status: not run.**

## Local memory required for this test

Previous canonical mask/shape reference and identity

## Measured new evidence and decision / episode timing

At `1`, the 20-pixel L becomes a 20-pixel cross, with no fitting rigid transform

## Required caution and fixture insufficiency

Do not substitute a new-object explanation unless correspondence is genuinely unresolved.
...
|---|---|---|
| `recordings/events_tests/shape_changed` | event_baseline | 2 |
