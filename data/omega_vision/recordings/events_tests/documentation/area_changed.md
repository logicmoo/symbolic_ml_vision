...
One centered boundary protrusion increases occupied area.

**Execution status: not run.**

## Local memory required for this test

Previous occupied-pixel count, contour and visibility completeness

## Measured new evidence and decision / episode timing

At `1`, area changes from 64 to 66 via a boundary protrusion

## Required caution and fixture insufficiency

Require exact-resolution measurements/tolerance that retain the two-pixel change. Do not count clipping or uniform scale as this case's intended explanation.
...
|---|---|---|
| `recordings/events_tests/area_changed` | event_baseline | 2 |
