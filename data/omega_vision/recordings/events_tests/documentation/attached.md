...
Two long edges join into an assembly, hold, then detach.

**Execution status: not run.**

## Local memory required for this test

Prior disjoint group membership, strong-edge/cutout proof, extraction completeness and policy hash

## Measured new evidence and decision / episode timing

Proof appears at `1`, remains with joint movement at `2`, disappears on supported separation at `3`

## Required caution and fixture insufficiency

Missing/incomplete proof is unknown, not detach. A policy change requires consistent replay rather than closing the old episode.
...
|---|---|---|
| `recordings/events_tests/attached` | event_baseline | 4 |
