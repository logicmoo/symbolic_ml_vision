...
Actor travels behind an opaque foreground strip and emerges.

**Execution status: not run.**

## Local memory required for this test

Full actor shape before hiding, velocity from `0 -> 1`, occluder geometry/depth evidence and episode

## Measured new evidence and decision / episode timing

Full hiding at `2`; partial recovery at `3`; full emergence at `4` is the fixture's intended end

## Required caution and fixture insufficiency

Decide partial-reappearance versus fully-unoccluded episode policy explicitly. Do not close merely because some pixels reappear, nor import generator draw order as depth evidence.
...
|---|---|---|
| `recordings/events_tests/occlude` | event_baseline | 5 |
