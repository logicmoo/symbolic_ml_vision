...
A moving object leaves through the right boundary.

**Execution status: not run.**

## Local memory required for this test

Positions/masks from `0`, `1`, `2`, viewport bounds and prior velocity

## Measured new evidence and decision / episode timing

At `3`, projected continuation crosses the right boundary and the actor is no longer visible

## Required caution and fixture insufficiency

Absence alone is insufficient. Preserve the last visible observation and the projection proof.
...
|---|---|---|
| `recordings/events_tests/exited` | event_baseline | 4 |
