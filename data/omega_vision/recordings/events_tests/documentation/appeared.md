...
An object becomes visible in the interior, not at a border.

**Execution status: not run.**

## Local memory required for this test

Frame `0`'s complete empty interior, viewport and visibility coverage

## Measured new evidence and decision / episode timing

At `1`, establish a new visible observation in the interior and rule out border entry within the observed interval; preserve it at `2`

## Required caution and fixture insufficiency

Does not prove physical creation or absence before frame `0`. Current unmatched-visible handling is not already an `appeared` detector.
...
|---|---|---|
| `recordings/events_tests/appeared` | event_baseline | 3 |
