...
Two outlined shapes geometrically overlap then separate.

**Execution status: not run.**

## Local memory required for this test

Remembered independent shapes/poses, observed versus inferred mask distinction and relation episode

## Measured new evidence and decision / episode timing

Independently supported projected overlap starts at `1`, persists at `2`, ends at `3`

## Required caution and fixture insufficiency

Painted visible masks cannot share the same raster pixel. Reconstruct hidden portions from evidence or keep amodal overlap hypothetical; the oracle masks are forbidden inputs.
...
|---|---|---|
| `recordings/events_tests/overlap` | event_baseline | 4 |
