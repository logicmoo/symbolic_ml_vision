...
Negative control: identical complete observations.

**Execution status: not run.**

## Local memory required for this test

Complete previous observation and identity/geometry/appearance/relationship state

## Measured new evidence and decision / episode timing

Compare both identical images and all relevant observable state

## Required caution and fixture insufficiency

Empty event list and `no_material_change` for `0 -> 1`; frame `0` remains an initial observation.
...
|---|---|---|
| `recordings/events_tests/no_material_change` | event_baseline | 2 |
