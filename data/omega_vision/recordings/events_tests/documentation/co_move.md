...
Separated objects move together then their velocities diverge.

**Execution status: not run.**

## Local memory required for this test

Prior rigid transforms/velocities for both tracks and co-motion truth

## Measured new evidence and decision / episode timing

After measured non-co-motion warm-up: common displacement starts, persists, then diverges

## Required caution and fixture insufficiency

Current initial frame cannot establish a previous velocity pair. Version the warm-up; joint motion does not prove attachment.
...
|---|---|---|
| `recordings/events_tests/co_move` | event_baseline | 4 |
