...
Two independent pieces form a coherent moving assembly.

**Execution status: not run.**

## Local memory required for this test

Independent member identities at `0`, accepted grouping criterion and new membership proposal

## Measured new evidence and decision / episode timing

Joined geometry at `1` proposes a group; rigid joint motion at `2` supplies additional support

## Required caution and fixture insufficiency

If support only becomes sufficient at `2`, do not backdate confirmation to oracle frame `1`. Group identity must be generated, not copied from `group`.
...
|---|---|---|
| `recordings/events_tests/group_formed` | event_baseline | 3 |
