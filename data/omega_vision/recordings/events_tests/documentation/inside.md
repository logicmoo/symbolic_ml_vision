...
The same enclosure evidence with subject roles reversed

## Measured new evidence and decision / episode timing

Inverse lifecycle of `contain(container, actor)`: `inside(actor, container)`

## Required caution and fixture insufficiency

Needs an explicit accepted inverse rule or detector. Registration in the term vocabulary alone does not implement it.
...
|---|---|---|
| `recordings/events_tests/inside` | event_baseline | 4 |
