...
One translation, with no intended shape or color change.

**Execution status: not run.**

## Local memory required for this test

Previous matched observation, centroid/mask and transform tolerance

## Measured new evidence and decision / episode timing

At `1`, measure displacement `(4, 0)` against frame `0` and deduce `moved`

## Required caution and fixture insufficiency

This does not by itself prove movement *started*; prior velocity is unknown.
...
|---|---|---|
| `recordings/events_tests/moved` | event_baseline | 2 |
