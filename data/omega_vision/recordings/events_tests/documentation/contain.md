...
Enclosure starts, persists, and ends.

**Execution status: not run.**

## Local memory required for this test

Enclosure boundary/interior and directional container/contained identity pair

## Measured new evidence and decision / episode timing

Outside at `0`, enclosed at `1`, still enclosed at `2`, outside at `3`

## Required caution and fixture insufficiency

The hollow interior is not foreground mask overlap. Require a supported enclosed-interior relation, not just overlapping bounding boxes.
...
|---|---|---|
| `recordings/events_tests/contain` | event_baseline | 4 |
