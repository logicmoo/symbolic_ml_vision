...
Two bodies touch, remain touching, then separate.

**Execution status: not run.**

## Local memory required for this test

Previous boundary-contact truth, stable subject pair and episode

## Measured new evidence and decision / episode timing

Noncontact at `0`, shared edge at `1`, contact at `2`, separation at `3`

## Required caution and fixture insufficiency

Measured contact does not by itself establish attachment, force or collision.
...
|---|---|---|
| `recordings/events_tests/contact` | event_baseline | 4 |
