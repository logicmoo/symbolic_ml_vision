...
Rightward speed decreases from four to two pixels per second.

**Execution status: not run.**

## Local memory required for this test

The same three-frame speed history

## Measured new evidence and decision / episode timing

At `2`, speed falls from 4 to 2 pixels per second

## Required caution and fixture insufficiency

A smaller displacement is not slower speed without timing evidence.
...
|---|---|---|
| `recordings/events_tests/decelerated` | event_baseline | 3 |
